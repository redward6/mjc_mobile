...
var bouton = document.querySelector('.arrow');
var cible = document.querySelector('.page_evenements');
var rick = document.querySelector('.testooo');
...
function smooth_scroll(target, duration) {
  ...
  var target_position = target.getBoundingClientRect().top; // Prend la position du haut de l'element par rapport au haut de l'ecran du user

  var start_position = window.pageYOffset;
  console.log(start_position);
  console.log(target_position); // Prend en compte la position du user sur la page en Y
